...
| 6 | Deploy to a $0 Free Tier VM | — | SSH in, `docker compose up -d`, curl the URL. **Live outcome: AWS** `54.208.101.60` (us-east-1) — `notes/day-06-aws-deploy-2026-09-11-1718.md`. |
...
**What you learn**: Enough TypeScript/Python to be dangerous, basic PostgreSQL, Docker Compose, $0 Free Tier VM, GitHub Actions.
...
| 25-26 | Deploy full stack | — | Frontend + backend on $0 Free Tier VM, single URL |
...
| 12 | K3s on $0 Free Tier VM, Helm charts | — | Kubernetes basics, Helm templating |
...
| 6 | Deploy to a $0 Free Tier VM | `docker compose up -d`, curl works (live: AWS — see Day 6 note) |
